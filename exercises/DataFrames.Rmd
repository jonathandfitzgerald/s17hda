...
3. Something with importing their own data and manipulating it. Perhaps ask them to id if it's wide or long data and whether its current format is right for what they need.
