...
Since last week I figured out why my tibbles weren't funtioning as I expected: in short, there's also a new function for importing CSVs (`read_csv` with an underscore) that imports directly into a tibble. To see one difference, check the class of the `text` column after importing the Viral Texts data below.
