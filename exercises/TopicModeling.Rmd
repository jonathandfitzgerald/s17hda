...
Now we've got the Wright data just like last week. You might notice that we've got a more human readable title for these texts this time. If you look in the `readWright.R` file you'll see these two lines, which may by this point be self explanatory, though I'll confess that the positive lookbehind at the front and positive lookahead at the end were figured out by Fitz and bend my brain a little bit: 
