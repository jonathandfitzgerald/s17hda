...
Now you can look at the most common words at greater length. Feel free to experiment with the topics sampled and the number of words shown from each. This will help you get a sense, I hope, of what a "topic" comprises.
...
With a few more data transformation, we can also correlate topics with texts:
...
topicDF %>% filter() %>% 
  geom_point(aes(x = proportion, y = topic))
