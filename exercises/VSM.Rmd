...
```{r}
wright_model %>% plot(perplexity=10)
```
...
```{r}
wright_model %>% closest_to('woman', 20) %>%
  View()
```
...
```{r}
wright_model %>% closest_to(~'dog'+'cat',20) %>%
  View()
```
...
```{r}
wright_model %>% closest_to(~'man'-'woman',20) %>%
  View()
wright_model %>% closest_to(~'woman'-'man',20) %>%
  View()
```
